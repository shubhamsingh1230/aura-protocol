...
export default function LandingAuthClient() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-zinc-50 via-zinc-100 to-emerald-50/50 text-zinc-900 flex flex-col items-center justify-center p-4 selection:bg-emerald-500 selection:text-white relative overflow-hidden">
      ...
      >
        ...
        <div className="space-y-2">
          ...
          <p className="text-xs sm:text-sm text-zinc-600 font-medium leading-relaxed max-w-xs mx-auto">
            A real-world productivity game. Track anti-cheat daily pillars, compete in friend arenas, and unlock progressive AP lobbies.
          </p>
        </div>
        ...
        <div className="space-y-3 pt-2">
          ...
          <motion.button
            ...
            className="w-full py-4 px-4 rounded-2xl bg-white hover:bg-zinc-50 text-zinc-900 font-bold text-xs flex items-center justify-center gap-3 transition-all shadow-md border border-zinc-200/80 cursor-pointer"
          >
          ...
          <motion.button
            ...
            className="w-full py-4 px-4 rounded-2xl bg-[#5865F2] hover:bg-[#4752C4] text-white font-bold text-xs flex items-center justify-center gap-3 transition-all shadow-md cursor-pointer"
          >
      ...
      {/* Footer Info */}
      <div className="mt-6 text-center text-[11px] text-zinc-500 font-medium relative z-10">
        <p>Instant authentication. Profiles, streaks, and AP sync automatically across sessions.</p>
      </div>
    </main>
  );
}
