...
import { Flame, Flag, CheckCircle, Clock } from "lucide-react";
              ...
              <div key={card.userId} className="liquid-glass rounded-3xl p-4 space-y-4 border border-white/80 shadow-sm">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button 
                    ...
                    className="p-2 rounded-xl bg-zinc-100 hover:bg-red-50 text-zinc-400 hover:text-red-500 transition-colors"
                    title="Flag Proof"
                  >
